...
void DialogUserRegistration::on_pushButton_clicked()
{
    ...
    //检查账号是否已存在；
    QString sql_statement=QString("select * from user_info where user_account='%1'").
    ...
    sql_statement = QString("INSERT INTO user_info(user_account, user_password, user_nickname, user_avatar, registration_time, last_login_time) values");
    sql_statement+=QString("('%1','%2','%3','%4','%5','%6')")
